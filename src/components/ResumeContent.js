  ...
  return (
    <div className="ResumePageContainer">
      <div>
        ...
        <div className="resumeLink">Click <a className="blueLink" href="https://drive.google.com/file/d/16iIb40M8CskTGLTy-WCD9yw6d3FvDsWL/view?usp=sharing" target="_blank" rel="noreferrer">here</a> for a docx version of my resume.</div>
      </div>
    </div>
  );
};
