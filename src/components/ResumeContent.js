  ...
  return (
    <div className="ResumePageContainer">
      <div>
        ...
        <div className="resumeLink">Click <a className="blueLink" /*href="https://docs.google.com/document/d/00000000000000/edit"*/ target="_blank" rel="noreferrer">here</a> for a docx version of my resume.</div>      </div>
    </div>
  );
};
